...
## Intro
**Calculamelon** is an application to learn math using a language without numbers or letters, just basic math symbols and fruits. With an intuitive **playground**, a repository of **published formulas** managed by a **democratic community**.
## Features
### Frontend
